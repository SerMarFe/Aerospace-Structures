function [q, tau, s] = getTangentialStressDistributionClosed(x,Tn,m,Tm,Xc,Ixx,Iyy,Ixy,Sx_ext,Sy_ext,Xs,Ain)
    ...
    % Initial shear force:
    q(1,1) = (Sy*(Xc(1)-Xs(1))-Sx*(Xc(2)-Xs(2)))/(2*Ain);  % Closed section
